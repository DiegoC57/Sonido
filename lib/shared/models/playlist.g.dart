...
Playlist _playlistDeserialize(
  ...
  final object = Playlist(
    ...
    songIds: reader.readLongList(offsets[3]),
  );
  object.id = id;
  return object;
}
...
extension PlaylistQueryFilter
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> songIdsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'songIds'),
      );
    });
  }
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> songIdsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'songIds'),
      );
    });
  }
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> songIdsElementEqualTo(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'songIds', value: value),
      );
    });
  }

  QueryBuilder<Playlist, Playlist, QAfterFilterCondition>
  songIdsElementGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition>
  songIdsElementLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
